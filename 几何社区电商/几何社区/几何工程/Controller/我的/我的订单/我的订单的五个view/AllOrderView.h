...
@interface AllOrderView : UIView<UITableViewDataSource,UITableViewDelegate,JHDataMagerDelegate,UIActionSheetDelegate,MJRefreshBaseViewDelegate,MainDelegate,UIAlertViewDelegate>
{
