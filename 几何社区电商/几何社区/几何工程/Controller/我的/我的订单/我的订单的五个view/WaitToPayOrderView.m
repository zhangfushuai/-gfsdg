...
@implementation WaitToPayOrderView
-(void)layoutSubviews{
    [super layoutSubviews];
    _manager.delegate =self;
    
    NSDictionary *dic =@{@"page":@"1"};
    [_manager getWaitForPayOrderWithPageParams:dic];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    MyOrderModel *model = self.allOrderArr[indexPath.section];
        ...
        WaitForPayTableViewCell *cell = [[[NSBundle mainBundle]loadNibNamed:@"WaitForPayTableViewCell" owner:self options:0]firstObject];
        // }
