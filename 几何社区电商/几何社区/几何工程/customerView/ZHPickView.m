...
-(void)setUpPickView{
    ...
    pickView.backgroundColor=RGBCOLOR(234,234, 234, 1);
...
//    long long time2 = 3784320000;
//    long long time  = time1 -time2;
//    NSDate *date2 = [[NSDate date] initWithTimeIntervalSince1970:time];
    NSDate *date3 = [self yearFormatDay];
    datePicker.minimumDate = date3;
...
- (NSDate *)yearFormatDay  //120距今的时间
{
    ...
    NSInteger year1 = year - 120;
    NSInteger month = [comps month];
    NSInteger day = [comps day];
    NSInteger hour = [comps hour];
    NSInteger minutes = [comps minute];
    NSInteger second = [comps second];
    NSString *dayStr = [NSString stringWithFormat:@"%4ld-%02ld-%02ld %02ld:%02ld:%02ld",(long)year1,(long)month,(long)day,(long)hour,(long)minutes,(long)second];
